...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    category: "web",
    title: "Tapas-Grocery",
    image: "/assets/projects/tapas-grocery.webp",
    ...
    screenshots: [
      "/assets/projects/tapas-grocery.webp",
      "/assets/projects/tapas-grocery.webp",
      "/assets/projects/tapas-grocery.webp",
    ],
  ...
  },
  {
    ...
    image: "/assets/projects/voice.webp",
  ...
  },
  {
    ...
    category: "web",
    title: "Kurmi-Chatbot",
    image: "/assets/projects/kurmiai.webp",
  ...
  },
  {
    ...
    category: "web",
    title: "Campus Coins",
    image: "/assets/projects/expense.webp",
  ...
  },
  {
    ...
    category: "web",
    title: "Music Player",
    image: "/assets/projects/music.webp",
  ...
  },
  {
    ...
    category: "tools",
    title: "FutureHax",
    image: "/assets/projects/hax.webp",
  ...
  },
  {
    ...
    category: "web",
    title: "DataVault",
    image: "/assets/projects/datavault.webp",
    ...
    screenshots: [
      "/assets/projects/datavault.webp",
      "/assets/projects/datavault.webp",
      "/assets/projects/datavault.webp",
    ],
...
export const SKILL_GROUPS: SkillGroup[] = [
  {
    ...
    summary: "Accessible, fast interfaces with motion that supports the content instead of fighting it.",
    accent: "56 189 248",
    items: [
      { name: "React", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/react/react-original.svg", level: 92, note: "Hooks, context, and composition patterns" },
      { name: "Next.js", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nextjs/nextjs-original.svg", invert: true, level: 90, note: "App Router, RSC, and route handlers" },
      { name: "TypeScript", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/typescript/typescript-original.svg", level: 88, note: "Strict types across app and API surfaces" },
      { name: "JavaScript", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-original.svg", level: 92, note: "Async flows, DOM internals, modern ES" },
      { name: "Tailwind CSS", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/tailwindcss/tailwindcss-original.svg", level: 93, note: "Design tokens and utility-first systems" },
      { name: "Framer Motion", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/framermotion/framermotion-original.svg", invert: true, level: 84, note: "Scroll, layout, and gesture animation" },
      { name: "HTML5", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/html5/html5-original.svg", level: 95, note: "Semantic markup and a11y landmarks" },
      { name: "CSS3", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/css3/css3-original.svg", level: 90, note: "Grid, container queries, fluid type" },
      { name: "Bootstrap", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/bootstrap/bootstrap-original.svg", level: 78, note: "Rapid responsive prototyping" },
      { name: "Vite", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/vitejs/vitejs-original.svg", level: 80, note: "Fast dev server and bundle tuning" },
    ],
  },
  {
    id: "backend",
    ...
    summary: "Typed API surfaces, clear auth boundaries, and predictable request lifecycles.",
    accent: "45 212 191",
    items: [
      { name: "Node.js", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nodejs/nodejs-original.svg", level: 88, note: "Streams, workers, runtime profiling" },
      { name: "Express.js", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/express/express-original.svg", invert: true, level: 86, note: "Middleware chains and error handling" },
      { name: "NestJS", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nestjs/nestjs-original.svg", level: 74, note: "Modular DI-driven service structure" },
      { name: "REST APIs", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/fastapi/fastapi-original.svg", level: 90, note: "Versioning, pagination, idempotency" },
      { name: "GraphQL", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/graphql/graphql-plain.svg", level: 72, note: "Schema design and resolver batching" },
      { name: "JWT / Auth", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/oauth/oauth-original.svg", level: 85, note: "Session strategy and token rotation" },
      { name: "Laravel", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/laravel/laravel-original.svg", level: 70, note: "Eloquent, queues, and blade services" },
      { name: "Socket.IO", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/socketio/socketio-original.svg", invert: true, level: 74, note: "Realtime channels and presence" },
    ],
  },
  {
    id: "database",
    ...
    summary: "Schema design, indexing, and query paths chosen for the read and write shape of the product.",
    accent: "129 140 248",
    items: [
      { name: "PostgreSQL", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/postgresql/postgresql-original.svg", level: 84, note: "Joins, CTEs, indexes, row-level security" },
      { name: "MongoDB", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mongodb/mongodb-original.svg", level: 88, note: "Aggregation pipelines and schema modelling" },
      { name: "MySQL", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mysql/mysql-original.svg", level: 82, note: "Normalisation and query plan tuning" },
      { name: "Redis", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/redis/redis-original.svg", level: 78, note: "Caching, rate limits, ephemeral state" },
      { name: "Supabase", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/supabase/supabase-original.svg", level: 85, note: "Postgres, auth, storage, RLS policies" },
      { name: "Firebase", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/firebase/firebase-plain.svg", level: 86, note: "Firestore rules and realtime sync" },
      { name: "Prisma", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/prisma/prisma-original.svg", invert: true, level: 80, note: "Type-safe models and migrations" },
      { name: "Mongoose", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mongoose/mongoose-original.svg", level: 82, note: "Schemas, hooks, population strategy" },
      { name: "SQL", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/azuresqldatabase/azuresqldatabase-original.svg", level: 85, note: "Analytical queries and window functions" },
    ],
  },
  {
    id: "languages",
    title: "Languages",
    kicker: "Core Fluency",
    summary: "General-purpose languages I use beyond the JavaScript stack for scripting and server-side work.",
    accent: "251 191 36",
    items: [
      { name: "Python", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg", level: 87, note: "Automation, scripting, and ML tooling" },
      { name: "PHP", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/php/php-original.svg", level: 68, note: "Server-rendered app maintenance" },
    ],
  },
  {
    id: "delivery",
    ...
    kicker: "Ship Layer",
    summary: "The pipeline from a local branch to a deployed, observable production build.",
    accent: "244 114 182",
    items: [
      { name: "Git", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/git/git-original.svg", level: 90, note: "Rebase workflows and clean history" },
      { name: "GitHub Actions", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/githubactions/githubactions-original.svg", level: 78, note: "CI checks, previews, release jobs" },
      { name: "Docker", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/docker/docker-original.svg", level: 74, note: "Reproducible images and compose stacks" },
      { name: "Vercel", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/vercel/vercel-original.svg", invert: true, level: 88, note: "Edge deploys and runtime config" },
      { name: "Postman", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/postman/postman-original.svg", level: 85, note: "API contracts and regression collections" },
      { name: "VS Code", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/vscode/vscode-original.svg", level: 94, note: "Debuggers, tasks, extension workflows" },
      { name: "Figma", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/figma/figma-original.svg", level: 80, note: "Design handoff and component specs" },
      { name: "Linux", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/linux/linux-original.svg", level: 84, note: "Daily driver, services, permissions" },
    ],
  },
  {
    id: "security",
    title: "Security",
    kicker: "Defence Layer",
    summary: "Offensive testing habits fed back into how the application is designed and hardened.",
    accent: "248 113 113",
    items: [
      { name: "Penetration Testing", icon: "https://cdn-icons-png.flaticon.com/512/4021/4021693.png", level: 82, note: "Scoped assessments and reporting" },
      { name: "Burp Suite", icon: "https://cdn-icons-png.flaticon.com/512/732/732212.png", level: 80, note: "Intercept, repeater, and auth testing" },
      { name: "Wireshark", icon: "https://cdn.iconscout.com/icon/free/png-256/wireshark-3628989-3030070.png", level: 76, note: "Packet capture and protocol analysis" },
      { name: "Nmap", icon: "https://cdn-icons-png.flaticon.com/512/2913/2913465.png", level: 78, note: "Recon, service and version mapping" },
      { name: "Kali Linux", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/linux/linux-original.svg", level: 82, note: "Toolchain for assessment workflows" },
      { name: "OWASP Top 10", icon: "https://cdn-icons-png.flaticon.com/512/2989/2989988.png", level: 85, note: "Threat modelling against common classes" },
    ],
  },
];
...
export const EXPERIENCE_ITEMS: ExperienceItem[] = [
  {
    ...
    location: "Remote",
    description:
      "Developed React/Next.js features, integrated REST APIs, connected frontend workflows, and optimized UI performance. Shipped reusable components and collaborated in a remote agile team to deliver production-ready application updates.",
    skills: ["React", "Next.js", "REST APIs", "Frontend Workflows", "UI Performance"],
  },
];
...
export const TRUST_METRICS: TrustMetric[] = [
  ...
  { label: "Internships", value: "1", note: "Full-stack development role" },
